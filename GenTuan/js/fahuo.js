...
$(function(){
    ...
    $("#top>img").css({"position":Q(-5),"width":Q(294),"height":Q(52)});
    ...
    $(".list").css({"padding-top":Q(23),"padding-bottom":Q(23),"padding-left":Q(20),"padding-right":Q(20),"font-size":Q(32),"margin-bottom":Q(40)});
    $(".list>ul>li").css({"line-height":Q(70)});
	$("#tjcg>img").css({"width":Q(160),"height":Q(68),"margin-top":Q(30)});
